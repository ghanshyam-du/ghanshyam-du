...
**Step 1:** Create a new file `.github/workflows/snake.yml` in your repository
...
**Step 3:** Go to your repository Settings → Actions → General → Workflow permissions → Select "Read and write permissions" → Save

**Step 4:** Go to Actions tab → Click "Generate Snake" → Run workflow

The snake will update automatically every 12 hours!
